...
//     const user= await axiosClient.get(`/user/${decodedtoken.id}`);     
//     setUser(user.data);   
//   }   //fetch organization details of user   
//   const fetchOrganizationDetails= async (organizationId)=>{     
//     const organization= await axiosClient.get(`/organization/${organizationId}`);     
//     setOrganization(organization.data);
//   }   
//   //fetch all the teams with details (role,userole,memeber,name)    
//   const fetchTeamDetails = async ()=>{     
//     const team=await axiosClient.get(`/team/user/${User._id}`);     
//     setTeam(team.data);   }   
//     //fetch all the teams in user's organization   
//     const fetchOrgTeam=async ()=>{     
//       const orgteam=await axiosClient.get(`/team/organization/${User._id}`);     
//       setOrgTeam(orgteam);   }   
//       //fetch all project user is working on with its details   
//     const fetchProjects = async ()=>{     
//       const project= await axiosClient.get(`/project/${User._id}`);     
//       setProject(project);   
//     }   
//     fetchUserDetails();    
...
//     }   
//     return (     
//     <div className="text-2xl text-center text-indigo-600 mt-10">       
